...
function wp_bootstrap_starter_scripts()
{
    ...
    //load theme
    wp_enqueue_style('custom-app-css', get_template_directory_uri() . '/inc/assets/css/app.css');
    // Load owlCarousel Style
    wp_enqueue_style('owl-css', get_template_directory_uri() . '/inc/assets/css/plugins/owlCarousel/owl.carousel.css');
    wp_enqueue_style('owl-theme-css', get_template_directory_uri() . '/inc/assets/css/plugins/owlCarousel/owl.theme.default.css');
    ...
    // Load custom js
    wp_enqueue_script('custom-js', get_template_directory_uri() . '/inc/assets/js/app.js', array(), '', true);
    // Load owlCarousel
    wp_enqueue_script('owl-theme-js', get_template_directory_uri() . '/inc/assets/js/plugins/owlCarousel/owl.carousel.min.js', array(), '', true);
